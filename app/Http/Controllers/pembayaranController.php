...
class pembayaranController extends Controller
{
    ...
    public function premiumPaket()
    {
        ...
        $potongan_harga_tiga_bulan = $harga_tiga_bulan*($diskonPaket['tiga_bulan']/100);
        ...
        $potongan_harga_enam_bulan = $harga_enam_bulan*($diskonPaket['enam_bulan']/100);
        ...
        $potongan_harga_dua_belas_bulan = $harga_dua_belas_bulan*($diskonPaket['dua_belas_bulan']/100);
        ...
        $potongan_harga_dua_puluh_empat_bulan = $harga_dua_puluh_empat_bulan*($diskonPaket['dua_puluh_empat_bulan']/100);
