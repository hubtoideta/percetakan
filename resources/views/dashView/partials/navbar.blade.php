                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">{{ ucwords($userLogin->username) }}
                                        <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ ucwords($userLogin->category) }}</span>
                                    </div>
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{ $userLogin->email }}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('logout') }}"class="menu-link">
                                <span class="menu-icon">
                                    <i class="ki-outline ki-exit-right text-danger fs-2"></i>
                                </span>
